...
export const EGameStatusType = { Idle: 0, ComputerPlaying: 1, PersonPlaying: 2, GameOver: 3, state: 0 };
...
export function spawnColorButton(){ //få knappene til å trykke seg selv
EGameStatusType.state = EGameStatusType.ComputerPlaying; // sier at stausen er at det er computer som trykker på knapp
